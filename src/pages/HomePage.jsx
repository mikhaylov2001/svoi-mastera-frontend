          ...
          <div className="hero-grid">
            ...
            <div className="hero-card fade-up-2">
              ...
              <div className="hero-stats-row">
                {[['24/7', 'Заявки'], ['9', 'Категорий'], ['5.0★', 'Рейтинг']].map(
                  ([n, l]) => (
          ...
          <div className="container">
            <div className="home-cta">
              <div className="cta-text">
                ...
                <p>
                  Зарегистрируйтесь бесплатно и получите первые отклики уже через 10 минут
                </p>
              </div>
              <button
      ...
      {showGuestModal && (
        <div className="modal-overlay" onClick={() => setShowGuestModal(false)}>
          ...
          >
            ...
            <p>
              Вам будет доступно: предложения мастеров, чат, безопасные сделки.
            </p>
