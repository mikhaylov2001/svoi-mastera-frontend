          ...
          <div className="nl-grid">
            ...
            <div className="nl-side-card">
              ...
              <ol className="nl-steps">
                {[
                  ...
                  ['Получайте заказы', 'Заказчик принимает объявление — сделка оформляется сразу'],
                  ['Выполняйте работу', 'Статус и переписка — в разделе «Мои сделки»'],
            ...
            <div className="nl-side-card">
              ...
              <ul className="nl-perks">
                {[
                  ['Прямая сделка', 'Заказчик принимает объявление по указанной цене'],
