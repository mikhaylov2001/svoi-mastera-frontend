        ...
        <div className="mp-body">
          <div className="mp-main">
            <div className="mp-stats">
              <Link to="/deals" className="mp-stat mp-stat-blue"><div className="mp-stat-ico blue"><FaBriefcase /></div><div className="mp-stat-num">{activeDealsCount}</div><div className="mp-stat-lbl">В работе</div></Link>
              <Link to="/deals" className="mp-stat mp-stat-green"><div className="mp-stat-ico green"><FaCheckCircle /></div><div className="mp-stat-num">{completedCount}</div><div className="mp-stat-lbl">Завершено</div></Link>
              <Link to="/my-listings" className="mp-stat mp-stat-violet"><div className="mp-stat-ico violet"><FaListAlt /></div><div className="mp-stat-num">{activeListings.length}</div><div className="mp-stat-lbl">Объявления</div></Link>
              <a href="#reviews" className="mp-stat mp-stat-amber" onClick={(e) => { e.preventDefault(); setTab('reviews'); reviewsAnchor.current?.scrollIntoView({ behavior: 'smooth' }); }}><div className="mp-stat-ico amber"><FaStar /></div><div className="mp-stat-num">{avgRating > 0 ? avgRating.toFixed(1) : '0.0'}</div><div className="mp-stat-lbl">Рейтинг · {reviews.length}</div></a>
            </div>
