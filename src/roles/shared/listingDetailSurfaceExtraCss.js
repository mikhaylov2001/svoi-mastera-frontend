...
/* ── Статус сделки в карточке стоимости ── */
.ed--listing-detail .ed-deal-status {
  display: flex;
...
.ed--listing-detail .ed-deal-status-icon {
  flex-shrink: 0;
  width: 32px;
  height: 32px;
  border-radius: 10px;
...
.ed--listing-detail .ed-deal-status-body {
  min-width: 0;
  flex: 1;
}
.ed--listing-detail .ed-deal-status-body strong {
  display: block;
  font-size: 14px;
  font-weight: 800;
  color: #111827;
...
.ed--listing-detail .ed-deal-status-body p {
  margin: 0;
  font-size: 13px;
  line-height: 1.45;
  color: #6b7280;
...
.ed--listing-detail .ed-deal-status--wait {
  background: linear-gradient(135deg, #fffbeb 0%, #fef9c3 100%);
  border: 1px solid #fde68a;
}
.ed--listing-detail .ed-deal-status--wait .ed-deal-status-icon {
  background: #fef3c7;
  color: #b45309;
}
.ed--listing-detail .ed-deal-status--active {
  background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%);
  border: 1px solid #a7f3d0;
}
.ed--listing-detail .ed-deal-status--active .ed-deal-status-icon {
  background: #d1fae5;
  color: #059669;
}
.ed--listing-detail .ed-deal-status--done {
  background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%);
  border: 1px solid #bbf7d0;
}
.ed--listing-detail .ed-deal-status--done .ed-deal-status-icon {
  background: #dcfce7;
  color: #16a34a;
}

.ed--listing-detail .ed-card--pricing .ed-actions {
  margin-top: 16px;
  padding-top: 16px;
  border-top: 1px solid #f3f4f6;
}

.ed--listing-detail .ed-btn-soft {
  background: #fff7f3 !important;
  color: #c2410c !important;
  border: 1px solid #ffd9c8 !important;
  box-shadow: none !important;
}
.ed--listing-detail .ed-btn-soft:hover {
  background: #ffede5 !important;
  border-color: #ffc4a8 !important;
}

.ed--listing-detail .ed-btn--compact {
  margin-top: 4px;
  min-height: 44px !important;
  font-size: 14px !important;
}

.ed--listing-detail .ed-profile-link {
  display: block;
  width: 100%;
  margin-top: 4px;
  padding: 10px 0 0;
...
.ed--listing-detail .ed-profile-link:hover {
  text-decoration: underline;
}

.ed--listing-detail .ed-block--master .ed-cust-row {
  padding-bottom: 0;
}
